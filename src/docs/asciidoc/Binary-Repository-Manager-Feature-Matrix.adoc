...
This page is collaboratively edited by the maintainers of Archiva, Artifactory, Sonatype Nexus, Eclipse Package Drone, ProGet and MyGet, making it the most complete, up-to-date and non-biased comparison of Binary Repository Managers.

[frame="all", cols="3,5,5,5,5,5,5,5", options="header"]
|===
|Feature |Archiva |Artifactory | Nexus 2 | Nexus 3 |Package Drone |ProGet|MyGet
...
8+|*Artifacts and Metadata Storage*
