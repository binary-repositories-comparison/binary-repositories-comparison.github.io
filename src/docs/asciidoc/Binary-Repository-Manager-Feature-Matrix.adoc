...
This page is collaboratively edited by the maintainers of Archiva, Artifactory, CloudRepo, Sonatype Nexus, Eclipse Package Drone, ProGet and MyGet, making it the most complete, up-to-date and non-biased comparison of Binary Repository Managers.

[frame="all", cols="3,5,5,5,5,5,5,5,5", options="header"]
|===
|Feature |Archiva |Artifactory | CloudRepo | Nexus 2 | Nexus 3 |Package Drone |ProGet|MyGet
...
|image:cloudrepo0.png[CloudRepo0, width="100%", link="https://github.com/binary-repositories-comparison/binary-repositories-comparison.github.io/blob/master/images/cloudrepo0.png?raw=true"]
...
|https://www.cloudrepo.io/release-notes.html[Release History]
...
|http://docs.myget.org/docs/release-notes/myget-2.2[Release History]
...
|https://www.cloudrepo.io/tos.html[Proprietary]
|Eclipse Public License Version 1.0
|Eclipse Public License Version 1.0
|Eclipse Public License Version 1.0
|http://inedo.com/proget/license-agreement[Proprietary]
|https://www.myget.org/policies/terms[Proprietary]
...
a|
 ...
 |[red]*&#10008;*
a|
 - https://www.myget.org[www.myget.org] +
  - https://dotnet.myget.org[dotnet.myget.org]
...
|[green]*&#10004;* +
https://www.cloudrepo.io[CloudRepo] - 100% Cloud Based, Fully Managed, Artifact Repository.
|[red]*&#10008;*
|[red]*&#10008;*
|[green]*&#10004;* +
...
|[red]*&#10008;*
|[green]*&#10004;* http://www.myget.org/plans[Pricing] + http://www.myget.org/enterprise[Enterprise plan]

9+|*Artifacts and Metadata Storage*
...
|[green]*&#10004;* +
Fully configurable via https://admin.cloudrepo.io[Web Based Admin Console].
|[green]*&#10004;* +
...
|[green]*&#10004;* +
Not required. MyGet’s Maven metadata.xml is server calculated and is inherently up-to-date.
...
|[red]*&#10008;*
|[red]*&#10008;*
|[red]*&#10008;* (custom logo supported in Enterprise plan)
...
|[green]*&#10004;* +
Owner, Co-Owner, Publisher, Publisher (limited), Consumer
...
a|- available docs: https://www.cloudrepo.io/[site]
...
a|- available docs: http://inedo.com/support/documentation/proget[site]
a|-  available docs: http://www.myget.org/[site], http://docs.myget.org[docs], http://blog.myget.org[blog]
...
|[green]*&#10004;* +
configurable by retention count, etc
...
|[green]*&#10004;* +
- US$19 per month for unlimited users and repositories +
- https://www.cloudrepo.io/pricing.html[Detailed Pricing]
|[green]*&#10004;* +
...
|[red]*&#10008;*
|24/7 available
|[red]*&#10008;* http://status.myget.org[availability history]
