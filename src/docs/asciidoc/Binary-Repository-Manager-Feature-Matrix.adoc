...
|image:nexus30.png[Nexus30, width="100%", link="http://books.sonatype.com/nexus-book/3.0/reference/figs/web/ui-overview-admin.png"]
 +
image:nexus30.png[Nexus30, width="100%", link="http://books.sonatype.com/nexus-book/3.0/reference/figs/web/ui-list-filtering.png"]
...
|&#10004; +
API can be invoked from Groovy scripts that are published to the repository manager and executed there.
